...
@Test
	...
	ele.sendKeys("C:\\Users\\Sky\\Pictures\\Screenshots\\Screenshot (43).png");
	WebElement ele1= driver.findElement(By.xpath("//input[@formcontrolname='identification_documents']"));
	ele1.sendKeys("C:\\Users\\Sky\\Pictures\\Screenshots\\Screenshot (42).png");
	Thread.sleep(1000);
	...
	Set<String> childid=driver.getWindowHandles();
	 ...
	 driver.findElement(By.xpath("//input[@placeholder='Enter Phone number']")).sendKeys("9381220640");
	  ...
	  File dest=new File(".\\Screenshots\\"+"pp.png");
	  Files.copy(src, dest);
	  driver.quit();
	}
}
