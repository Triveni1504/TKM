...
/* (//input[@placeholder='Search for jewellery'])[2]/ancestor::div[@class='search_field']
 /following-sibling::div[@class='location_field'] 
  ancestor---> It Will Access Directly Grand Parent Locator
  following-siblibg---> It Will Access Directly parent Locator
  */
